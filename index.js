...
function addExtPanel() {
    ...
    $('#codex-master-toggle').on('change', function () { getSettings().enabled = this.checked; saveGlobal(); if (this.checked) { createFAB(); createPanel(); registerAPI(); } else { try { setExtensionPrompt(INJECT_KEY, '', 1, 0, false); } catch {} $('#codex-fab,#codex-panel').remove(); } });
}
